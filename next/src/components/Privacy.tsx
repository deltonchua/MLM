    ...
    <>
      ...
      <section className={styles['section']}>
        ...
        <p>
          ...
          Stripe to process payment--you can read more about how Stripe uses
      ...
      <section className={styles['section']}>
        <h2 className={styles['section-title']}>DO NOT TRACK</h2>
        <p>
      ...
      <section className={styles['section']}>
        <h2 className={styles['section-title']}>YOUR RIGHTS</h2>
        <p>
      ...
      <section className={styles['section']}>
        <h2 className={styles['section-title']}>DATA RETENTION</h2>
        <p>
      ...
      <section className={styles['section']}>
        <h2 className={styles['section-title']}>MINORS</h2>
        <p>The Site is not intended for individuals under the age of 18.</p>
      </section>
      <section className={styles['section']}>
        <h2 className={styles['section-title']}>CHANGES</h2>
        <p>
