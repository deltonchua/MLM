  ...
  return (
    <>
      <section className={styles['section']}>
        ...
        <p>
          This website is operated by Big Family. Throughout the site, the terms
          “we”, “us” and “our” refer to Big Family. Big Family offers this
      ...
      <section className={styles['section']}>
        ...
        <p>
          ...
          to notify you by contacting the email and/or billing address/phone
      ...
      <section className={styles['section']}>
        <h2 className={styles['section-title']}>SECTION 7 - OPTIONAL TOOLS</h2>
        <p>
      ...
      <section className={styles['section']}>
        ...
        <p>
          ...
          by us) provided &#39;as is&#39; and &#39;as available&#39; for your
        ...
        <p>
          In no case shall Big Family, our directors, officers, employees,
      ...
      <section className={styles['section']}>
        ...
        <p>
          You agree to indemnify, defend and hold harmless Big Family and our
      ...
      <section className={styles['section']}>
        <h2 className={styles['section-title']}>SECTION 15 - SEVERABILITY</h2>
        <p>
      ...
      <section className={styles['section']}>
        <h2 className={styles['section-title']}>SECTION 16 - TERMINATION</h2>
        <p>
      ...
      <section className={styles['section']}>
        <h2 className={styles['section-title']}>SECTION 18 - GOVERNING LAW</h2>
        <p>
      ...
      <section className={styles['section']}>
        ...
        <p>
          ...
          <a href='mailto:contact@bigfamily.world'>contact@bigfamily.world</a>.
        </p>
      </section>
    </>
  );
